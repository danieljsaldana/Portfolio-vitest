        ...
        <div class="about">
            ...
            <div class="about__profile">
                ...
                <div class="about__photo">
                    <figure>
                        <link rel="preload" href="/video/dani_loop.mp4" as="video">
                        <link rel="preload" href="/video/dani_cover.webp" as="image">
                        <video id="me_video" width="360" height="632" poster="/video/dani_cover.webp" type="video/mp4" src="/video/dani_loop.mp4" tabindex="-1" preload="auto" playsinline muted loop></video>
                    </figure>
...
export default defineComponent({
    setup() {
        ...
        const years_old = computed(() => { 
            const birthday = new Date("1993/03/22 21:00:00")
